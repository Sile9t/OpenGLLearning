...
const bool drawInPrimitivesMode = false;
...
int main() {
	...
	GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, " OpenGL for Learning", NULL, NULL);
	if (window == NULL) {
	...
	while (!glfwWindowShouldClose(window)) {
...

		{
			...
			//view = glm::rotate(view, (float)glfwGetTime()*(glm::radians(45.0f)), glm::vec3(0.0f, 0.0f, 0.5f));
		}
